                        ...
                        children: <Widget>[
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                  text: "\R${user.userModel.cart[index]["price"] / 100} \n\n",
                                  style: TextStyle(
                                      color: black,
                                      fontSize: 18,
                ...
                text: TextSpan(children: [
                  TextSpan(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w400)),
                  TextSpan(
                      text: " \R${user.userModel.totalCartPrice / 100}",
                      style: TextStyle(
                          color: primary,
                          fontSize: 22,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('You will be charged \R${user.userModel.totalCartPrice / 100} upon delivery!', textAlign: TextAlign.center,),
